...
<body> 
	...
	<div data-role="content">	
		<div class="ui-grid-a">
			<div class="ui-block-a"><a href="allevents.html" data-role="button" class="ui-btn-active ui-state-persist">All Events</a></div>
			<div class="ui-block-b"><a href="favorites.html" data-role="button">My Favorites</a></div>	   
		</div>
    <p>
...
<div data-role="navbar">
		<ul>
			...
			<li><a href="allevents.html" class="ui-btn-active ui-state-persist">Events</a></li>
		</ul>
	</div><!-- /navbar -->
	</div><!-- /footer -->
</div><!-- /page -->
